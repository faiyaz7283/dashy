...
export function StatusBar({ calendarLastRefresh, weatherLastRefresh }: StatusBarProps) {
  ...
  return (
    <>
      <div
        className={`flex-shrink-0 h-7 bg-gray-50 border-t border-gray-200 flex items-center justify-center px-4 text-xs text-gray-400 gap-8 transition-all duration-250 overflow-hidden ${
