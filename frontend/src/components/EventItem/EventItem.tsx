...
import { colors, radii, spacing, typography, memberColors, zIndices } from '../../theme/tokens'
...
function formatTimeRange(event: CalendarEvent): string {
  ...
  const start = new Date(event.start).toLocaleTimeString('en-US', opts)
  const end = new Date(event.end).toLocaleTimeString('en-US', opts)
  return `${start} – ${end}`
}
