...
### 8. Update frontend types (if needed)

If frontend consumes this field, update `frontend/src/types/index.ts`:
...
- Add new field to API documentation
- Update `README.md` if it's a major feature
- Document which API provides the data
